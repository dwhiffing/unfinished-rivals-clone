...
// TODO: fix bug where units move out of their cell when they pass over another unit
// TODO: ensure that units attack consistently
export class Hexes {
  ...
  getScreenFromHex = (hex) => {
    ...
    return {
      x: coords.x + this.strategyGame.SCALED_WIDTH,
      y:
  ...
  getHexFromScreen = ({ x, y }) =>
    this.get(this.ExtendedHexGrid.pointToHex(x, y - this.strategyGame.OFFSET_Y))
